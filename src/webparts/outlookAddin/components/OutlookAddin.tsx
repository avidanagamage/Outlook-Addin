...
import styles from './OutlookAddin.module.scss';
import { IOutlookAddinProps } from './IOutlookAddinProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { initializeIcons } from 'office-ui-fabric-react/lib/Icons';
import { useState } from 'react';
import { IFolder } from '../../../models/IFolder';
import { useEffect } from 'react';
import { ActionButton, PrimaryButton } from 'office-ui-fabric-react/lib/components/Button';
import { Checkbox } from 'office-ui-fabric-react/lib/components/Checkbox';
import { Icon } from 'office-ui-fabric-react/lib/components/Icon';
import { Spinner } from 'office-ui-fabric-react/lib/components/Spinner';
initializeIcons();

export const OutlookAddin: React.FunctionComponent<IOutlookAddinProps> = (props) => {
  ...
  return (
    <div className={styles.outlookAddin}>
