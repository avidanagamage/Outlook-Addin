...
export class GraphHelper {
  ...
  public getOneDriveFolders(): Promise<IFolder[]> {
    const header = {
      "Content-Security-Policy": `prefetch-src 'self'; connect-src 'self';`,
    };
    return this.graphClient
      //.api('me/drive/root/children')
      .api('sites/4129916b-ea27-4782-8e2b-2cad5141e7be/drives')
      .version('v1.0')
      ...
      .then((response): any => {
        let folders: IFolder[] = [];
        console.log('One Drive Folders api response: ', response);
